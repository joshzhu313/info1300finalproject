  ...
  <section class="banner" role="banner">
    ...
    <section id="about" class="section intro">
      <div class="container">
        <div class="center">
          ...
          <p>Thats why we started SUNA Breakfast! Cornell needs a fresh, healthy breakfast alternative
            that is complelty convient for you. Our incredibly delcious breakfast options
            will be delivered to you in the window you request!</p>
            <h1>How It Works</h1>
            <p>1) Go to the order form (online menu coming soon)</p>
      ...
      <section id="testimonials" class="section intro">
        ...
        <section id="order">
          <div class="container">
            <h6> Thank you for your order! We will get back to you as soon as possible. </h6>
          </div>
        </section>
